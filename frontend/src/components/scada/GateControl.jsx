import { CheckCircle2, Waves, X } from "lucide-react";
    ...
    <section className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Gercek kapak pozisyonlari ve aciklik yuzdeleri.</p>
        </div>
        {successMessage ? (
      ...
      {isEndpointMissing ? (
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-6 text-sm font-semibold text-slate-500 shadow-soft">
          Kayitli savak kapagi bulunamadi.
        </div>
      ) : null}
